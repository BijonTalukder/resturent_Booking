      ...
      <div className="max-w-7xl mx-auto py-8 px-6">
        <div className="grid grid-cols-1 text-center lg:text-left gap-8 lg:grid-cols-3">
          ...
          <div className="grid sm:grid-cols-1 lg:grid-cols-3 lg:col-span-2 gap-3">
            <div>
              <p className="font-semibold text-white text-[16px] underline decoration-primary underline-offset-4">
                Information
              </p>
              ...
              <ul className="mt-6 space-y-4 text-sm">
                <li>
                  <a
                    href="#"
                    className="text-white font-normal hover:text-primary transition-colors text-[15px]"
                  >
                    Custom Service
                  </a>
                </li>
                ...
                <li>
                  <a
                    href="#"
                    className="text-white font-normal text-[15px] hover:text-primary transition-colors"
                  >
                    FAQs
                  </a>
                </li>
            ...
            <div>
              <p className="font-semibold text-white underline decoration-primary underline-offset-4 text-[16px]">
                Company
              </p>
              ...
              <ul className="mt-6 space-y-4 text-sm">
                ...
                <li>
                  <a
                    href="#"
                    className="text-white transition hover:text-primary text-[15px]"
                  >
                    Privacy Policy
                  </a>
                </li>
            ...
            <div className="">
              <p className="font-semibold text-white text-[16px] text-center lg:text-start underline decoration-primary underline-offset-4">
                Get in Touch
              </p>
              <div>
                <ul className="mt-6 space-y-4 text-sm">
          ...
          <div>
            <div className="flex items-center gap-2 mt-8 mb-5">
              {/* <img
                ...
                style={{
                  boxShadow: "3px 3px 6px rgba(0,0,0,0.3), -3px -3px 6px rgba(255,255,255,0.04)",
                }}
              /> */}
              {/* <img
                src={mastercard}
