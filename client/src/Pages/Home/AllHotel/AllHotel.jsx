...
import { FaAngleLeft, FaAngleRight, FaCity, FaSwimmingPool, FaWifi } from "react-icons/fa";
  ...
  return (
    ...
    <div className="lg:max-w-[98%] grid grid-cols-2 gap-4 md:flex md:flex-col mx-auto">
      {hotels.map((hotel, index) => (
        <div key={index} className="flex flex-col md:flex-row rounded-lg border border-gray-200 shadow-sm overflow-hidden bg-white mb-4">
            ...
            <div className="flex flex-col lg:flex-row lg:gap-8">
              <div className="flex-1 md:space-y-4 md:border-b-2 lg:border-b-0 lg:border-r-2 border-gray-400 border-dashed lg:px-3 py-2 md:py-5 lg:py-0">
                <div className="flex flex-col lg:flex-row lg:items-center justify-between mb-2">
                  <h2 className="text-[10px] md:text-2xl font-semibold text-[#1A1A1A]">{hotel.name}</h2>
              ...
              <div className="md:min-w-[300px] md:space-y-5 text-start lg:text-right">
                ...
                <div className="lg:hidden">
                  <div className="text-[#5054D9] font-bold text-[9px] mb-2">
                    <span className=""> {hotel.price.discounted.toLocaleString()} BDT</span>
                  </div>
